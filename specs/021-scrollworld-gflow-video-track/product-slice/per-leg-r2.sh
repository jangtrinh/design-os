...
seed="source/ink-chain2/seed6.png"
for i in 7 8 9; do
  pkill -x "Google Chrome" 2>/dev/null; pkill -f "chrome-mac|for-testing" 2>/dev/null; sleep 14
...
echo "R2 DONE: $(ls source/ink-chain2/leg*.mp4|wc -l|tr -d ' ')/10"
