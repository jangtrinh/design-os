...
<p align="center">
  ...
  [<a href="#one-kit-four-systems">Gallery</a>] ·
...
## One kit, four systems

One command — `ui ds init --persona <slug>` — compiles the **same 27-component kit** into a
complete, contrast-proven design system. Four personas, four different products; not four
color-swaps. Every pair ships machine-verified (`paired AA · 0 failures` is printed on the
page, not promised in the docs).

<table>
  <tr>
    <td width="50%"><img src="docs/assets/readme/specimen-saas-aurora-minimal.png" alt="Button matrix in the saas-aurora-minimal persona — light, clean SaaS blue" /></td>
    <td width="50%"><img src="docs/assets/readme/specimen-kinetic-swiss-punk.png" alt="Button matrix in the kinetic-swiss-punk persona — flat Swiss red, zero radius" /></td>
  </tr>
  <tr>
    <td><b>saas-aurora-minimal</b><br/><sub>functional-saas · light</sub></td>
    <td><b>kinetic-swiss-punk</b><br/><sub>graphic-modernist · brutalist</sub></td>
  </tr>
  <tr>
    <td><img src="docs/assets/readme/specimen-velvet-noir.png" alt="Button matrix in the velvet-noir persona — dark luxury, gold primary, serif display" /></td>
    <td><img src="docs/assets/readme/specimen-abyssal-void-tech.png" alt="Button matrix in the abyssal-void-tech persona — near-black, neon glow accents" /></td>
  </tr>
  <tr>
    <td><b>velvet-noir</b><br/><sub>material-surface · dark luxury</sub></td>
    <td><b>abyssal-void-tech</b><br/><sub>immersive-cinematic · dark neon</sub></td>
  </tr>
</table>

Each page above is generated by `ui ds preview` from the compiled tokens + registry —
deterministic output, byte-stable, gated by the same four linters as everything else.
...
<img src="docs/assets/readme/paired-tokens-velvet-noir.png" alt="The paired-token section of a generated specimen: every role ships with its foreground partner and the measured contrast ratio — 14 pairs, 0 failures printed on the page" />
