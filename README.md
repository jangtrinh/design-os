...
Public sites shipped end to end with this toolchain — each repo documents, command by
command, how to reproduce it. The grid grows as new demos ship.
...
<table>
  ...
  <tr>
    <td><sub>343 WebP frames in two tiers, accent derived from the footage by <code>ui color</code>, DTCG tokens, the tenant scroll engine, five lint gates green.<br /><a href="https://jangtrinh.github.io/design-os-drone-showcase/">Live</a> · <a href="https://github.com/jangtrinh/design-os-drone-showcase/raw/main/docs/demo.mp4">video</a> · <a href="https://github.com/jangtrinh/design-os-drone-showcase#reproduce-it-with-designos">reproduce it</a></sub></td>
...
designer's hand edits flow back into the same registry the agent generates from, so the two
never drift — and it holds under load: per-file cursors and log rotation keep sync fast on
...
<details>
<summary><b>All 36 <code>ui</code> commands</b></summary>
