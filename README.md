...
<table>
<tr>
<td width="50%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/architecture-dark.png"><img src="docs/images/examples/diagrams/architecture-light.png" width="460" alt="Three-tier web application"></picture><br><sub><b>architecture</b> — Three-tier web application</sub></td>
<td width="50%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/medallion-dark.png"><img src="docs/images/examples/diagrams/medallion-light.png" width="460" alt="Survey dataset storage tiers"></picture><br><sub><b>medallion</b> — Survey dataset storage tiers</sub></td>
</tr>
<tr>
<td width="50%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/charts/bar-dark.png"><img src="docs/images/examples/charts/bar-light.png" width="460" alt="Revenue by region, FY2025"></picture><br><sub><b>bar</b> — Revenue by region, FY2025</sub></td>
<td width="50%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/charts/quadrant-dark.png"><img src="docs/images/examples/charts/quadrant-light.png" width="460" alt="Q3 initiatives by effort and impact"></picture><br><sub><b>quadrant</b> — Q3 initiatives by effort and impact</sub></td>
</tr>
</table>
...
<table>
<tr>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/data-flow-dark.png"><img src="docs/images/examples/diagrams/data-flow-light.png" width="300" alt="Nightly reporting run"></picture><br><sub><b>data-flow</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/dp-integration-dark.png"><img src="docs/images/examples/diagrams/dp-integration-light.png" width="300" alt="Data platform integration surfaces"></picture><br><sub><b>dp-integration</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/dp-security-matrix-dark.png"><img src="docs/images/examples/diagrams/dp-security-matrix-light.png" width="300" alt="Platform entitlement matrix"></picture><br><sub><b>dp-security-matrix</b></sub></td>
</tr>
<tr>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/er-dark.png"><img src="docs/images/examples/diagrams/er-light.png" width="300" alt="Order model"></picture><br><sub><b>er</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/flowchart-dark.png"><img src="docs/images/examples/diagrams/flowchart-light.png" width="300" alt="Loan eligibility check"></picture><br><sub><b>flowchart</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/high-level-dark.png"><img src="docs/images/examples/diagrams/high-level-light.png" width="300" alt="Lakehouse capability sweep"></picture><br><sub><b>high-level</b></sub></td>
</tr>
<tr>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/it-state-dark.png"><img src="docs/images/examples/diagrams/it-state-light.png" width="300" alt="Statistics estate before modernisation"></picture><br><sub><b>it-state</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/layers-dark.png"><img src="docs/images/examples/diagrams/layers-light.png" width="300" alt="Runtime stack, hardware upward"></picture><br><sub><b>layers</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/loop-dark.png"><img src="docs/images/examples/diagrams/loop-light.png" width="300" alt="Platform operating cycle"></picture><br><sub><b>loop</b></sub></td>
</tr>
<tr>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/nested-dark.png"><img src="docs/images/examples/diagrams/nested-light.png" width="300" alt="Trust zones, outside in"></picture><br><sub><b>nested</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/org-chart-dark.png"><img src="docs/images/examples/diagrams/org-chart-light.png" width="300" alt="Engineering, who to reach"></picture><br><sub><b>org-chart</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/process-dark.png"><img src="docs/images/examples/diagrams/process-light.png" width="300" alt="Incident response runbook"></picture><br><sub><b>process</b></sub></td>
</tr>
<tr>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/product-flow-dark.png"><img src="docs/images/examples/diagrams/product-flow-light.png" width="300" alt="Checkout flow, partial view"></picture><br><sub><b>product-flow</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/sequence-dark.png"><img src="docs/images/examples/diagrams/sequence-light.png" width="300" alt="User sign-in exchange"></picture><br><sub><b>sequence</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/state-dark.png"><img src="docs/images/examples/diagrams/state-light.png" width="300" alt="Subscription lifecycle"></picture><br><sub><b>state</b></sub></td>
</tr>
<tr>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/swimlane-dark.png"><img src="docs/images/examples/diagrams/swimlane-light.png" width="300" alt="Expense claim ownership"></picture><br><sub><b>swimlane</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/diagrams/tree-dark.png"><img src="docs/images/examples/diagrams/tree-light.png" width="300" alt="Catalogue taxonomy, root at the leading edge"></picture><br><sub><b>tree</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/charts/gantt-dark.png"><img src="docs/images/examples/charts/gantt-light.png" width="300" alt="Reporting platform plan, H1 2026"></picture><br><sub><b>gantt</b></sub></td>
</tr>
<tr>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/charts/line-dark.png"><img src="docs/images/examples/charts/line-light.png" width="300" alt="Monthly active users, 2025"></picture><br><sub><b>line</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/charts/pyramid-dark.png"><img src="docs/images/examples/charts/pyramid-light.png" width="300" alt="Self-serve conversion funnel, Q2"></picture><br><sub><b>pyramid</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/charts/radar-dark.png"><img src="docs/images/examples/charts/radar-light.png" width="300" alt="Streaming engine capability profiles"></picture><br><sub><b>radar</b></sub></td>
</tr>
<tr>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/charts/scatter-dark.png"><img src="docs/images/examples/charts/scatter-light.png" width="300" alt="Response time against request size"></picture><br><sub><b>scatter</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/charts/timeline-dark.png"><img src="docs/images/examples/charts/timeline-light.png" width="300" alt="Release history, 2025"></picture><br><sub><b>timeline</b></sub></td>
<td width="33%"><picture><source media="(prefers-color-scheme: dark)" srcset="docs/images/examples/charts/venn-dark.png"><img src="docs/images/examples/charts/venn-light.png" width="300" alt="Overlap between three workspace roles"></picture><br><sub><b>venn</b></sub></td>
</tr>
</table>
