...
| Date | Change | Commit |
|---|---|---|
| 2026-08-19 | **Tractability telemetry events** — the ledger learns `route_decided`, `attempt_completed`, `outcome_recorded` (accept REQUIRES the final gate verdict) and `taste_veto` (mandatory reason; the FP gauge and the librarian's organic recurrence source) — the labeled-loop data the moat thesis lives on | `#199` |
