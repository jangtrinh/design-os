...
function tierCell(arm, tierId) {
  ...
  return `<td data-tier="${tier.id}" data-status="${escapeHtml(tier.status)}">
    ...
    <p class="environment">${escapeHtml(tier.environment)}</p>
