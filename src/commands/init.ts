...
Output paths:
  claude      → <cwd>/.claude/ease-design.json
                <cwd>/.claude/commands/ui/*.md  (18 slash-commands)
                <cwd>/.claude/skills/design-os-*/SKILL.md  (17 skills: 14 craft + 3 journey)
  antigravity → <cwd>/.agent/ease-design.json
                <cwd>/.agent/workflows/ui-*.md  (18 workflows)
                <cwd>/.agent/skills/design-os-*/SKILL.md  (17 skills: 14 craft + 3 journey)
