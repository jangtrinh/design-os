...
describe("generateAntigravityAdapter", () => {
  it("returns exactly 31 artifacts (16 workflows + 12 craft skills + 3 journey skills)", () => {
    expect(makeArtifacts()).toHaveLength(31);
  });
  ...
  it("13 artifacts are skill paths under .agent/skills/design-os-*/SKILL.md (12 craft + 3 journey)", () => {
