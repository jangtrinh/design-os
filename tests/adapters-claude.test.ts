...
describe("generateClaudeAdapter", () => {
  ...
  it("13 artifacts are skill paths under .claude/skills/design-os-*/SKILL.md (10 craft + 3 journey)", () => {
