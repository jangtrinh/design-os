...
describe("generateClaudeAdapter", () => {
  it("returns exactly 31 artifacts (17 commands + 11 craft skills + 3 journey skills)", () => {
  ...
  it("14 artifacts are skill paths under .claude/skills/design-os-*/SKILL.md (11 craft + 3 journey)", () => {
